...
model_bo_sk_2 = Model_Bayesian_Optimization(type_model = "Gaussian_Multivariate",Mean_model = Mean_model_sklearn_1,Covariance_model = Covariance_model_sklearn_1,Mixture_coefficient = Mixture_coefficient_sklearn_1,percent_pca = 0.75)
acquisition_ei = Acquisition_function(type_acquisition = "EI",type_choice='Best_so_far')
bo_no_mixtures_ei_sk_2 = BO(model_bo_sk_2,acquisition_ei)

model_bo_sk_3 = Model_Bayesian_Optimization(type_model = "Gaussian_Multivariate",Mean_model = Mean_model_sklearn_1,Covariance_model = Covariance_model_sklearn_1,Mixture_coefficient = Mixture_coefficient_sklearn_1,percent_pca = 0.5)
acquisition_ei = Acquisition_function(type_acquisition = "EI",type_choice='Best_so_far')
bo_no_mixtures_ei_sk_3 = BO(model_bo_sk_3,acquisition_ei)

model_bo_sk_4 = Model_Bayesian_Optimization(type_model = "Gaussian_Multivariate",Mean_model = Mean_model_sklearn_1,Covariance_model = Covariance_model_sklearn_1,Mixture_coefficient = Mixture_coefficient_sklearn_1,percent_pca = 0.25)
acquisition_ei = Acquisition_function(type_acquisition = "EI",type_choice='Best_so_far')
bo_no_mixtures_ei_sk_4 = BO(model_bo_sk_4,acquisition_ei)

model_bo_sk_5 = Model_Bayesian_Optimization(type_model = "Gaussian_Multivariate",Mean_model = Mean_model_sklearn_1,Covariance_model = Covariance_model_sklearn_1,Mixture_coefficient = Mixture_coefficient_sklearn_1,percent_pca = 0.1)
acquisition_ei = Acquisition_function(type_acquisition = "EI",type_choice='Best_so_far')
bo_no_mixtures_ei_sk_5 = BO(model_bo_sk_5,acquisition_ei)

################## Simulation ####################
filename = "./Plots/acquisition_LOS_with_number_of_steps_comp.dat"
